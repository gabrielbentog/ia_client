...
export default function ExerciseCard({ title, summary, href }: Props) {
  return (
    <article className="flex items-center justify-between rounded-xl bg-[#e9e8fd] px-6 py-6 text-[#110b3e]">
      ...
      <Link
        href={href}
        className="inline-flex items-center gap-1 rounded-full bg-[#18d38d] px-6 py-2 text-sm lg:text-base font-semibold text-white transition hover:brightness-110"
      >
        Começar Quiz
